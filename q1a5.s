...
ld    $a, r1            # r1 = address of a (struct A pointer)
ld    (r1), r1          # r1 = address that a points to
ld    (r1), r1          # r1 = address that a->x points to
...
ld    $a, r1            # r1 = address of a (struct A pointer)
ld    (r1), r1          # r1 = address that a points to
ld    20(r1), r1        # r1 = address of a->b.a
ld    (r1), r1          # r1 = a->b.a
